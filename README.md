...
Т.к при использования файла `.eslintignore` возникает ошибка с описание, что данный тип файла на текущий момент не поддерживается, то для игнорирования содержимого папки dist был использован файл `eslint.config.mjs`.
